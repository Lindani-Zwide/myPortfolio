...
const toggleNaviBar=function(){
  if(!isNavBarOpen){
      ...
      toggleNavBarBtn.innerHTML=`<img src="/Assets/Icons/close-menu.png" alt="open navigation bar icon">`
      isNavBarOpen=true
  }else{
    naviBar.style.right='-100%'
    overLayEl.style.display='none'
    toggleNavBarBtn.innerHTML=`<img src="/Assets/Icons/open-menu.png" alt="open navigation bar icon">`
    isNavBarOpen=false
  }
}
...
imageEl.innerHTML=` <img src="/Assets/images/image.jpg" alt="Photo of Lindani Ndwandwe" width="140" height="140">`